...
ConfigParam flink_params[] = {
    ...
    { "metrics.system-resource", "^metrics[._-]system[._-]resource$", "config.yaml" },
        // Parameters from flink-log4j-cli.properties (28 entries)
    { "monitorInterval", "^monitorInterval$", "flink-log4j-cli.properties" },
    { "rootLogger.level", "^rootLogger[._-]level$", "flink-log4j-cli.properties" },
    { "rootLogger.appenderRef.file.ref", "^rootLogger[._-]appenderRef[._-]file[._-]ref$", "flink-log4j-cli.properties" },
    { "appender.file.name", "^appender[._-]file[._-]name$", "flink-log4j-cli.properties" },
    { "appender.file.type", "^appender[._-]file[._-]type$", "flink-log4j-cli.properties" },
    { "appender.file.append", "^appender[._-]file[._-]append$", "flink-log4j-cli.properties" },
    { "appender.file.fileName", "^appender[._-]file[._-]fileName$", "flink-log4j-cli.properties" },
    { "appender.file.layout.type", "^appender[._-]file[._-]layout[._-]type$", "flink-log4j-cli.properties" },
    { "appender.file.layout.pattern", "^appender[._-]file[._-]layout[._-]pattern$", "flink-log4j-cli.properties" },
    { "logger.yarn.name", "^logger[._-]yarn[._-]name$", "flink-log4j-cli.properties" },
    { "logger.yarn.level", "^logger[._-]yarn[._-]level$", "flink-log4j-cli.properties" },
    { "logger.yarn.appenderRef.console.ref", "^logger[._-]yarn[._-]appenderRef[._-]console[._-]ref$", "flink-log4j-cli.properties" },
    { "logger.yarncli.name", "^logger[._-]yarncli[._-]name$", "flink-log4j-cli.properties" },
    { "logger.yarncli.level", "^logger[._-]yarncli[._-]level$", "flink-log4j-cli.properties" },
    { "logger.yarncli.appenderRef.console.ref", "^logger[._-]yarncli[._-]appenderRef[._-]console[._-]ref$", "flink-log4j-cli.properties" },
    { "logger.hadoop.name", "^logger[._-]hadoop[._-]name$", "flink-log4j-cli.properties" },
    { "logger.hadoop.level", "^logger[._-]hadoop[._-]level$", "flink-log4j-cli.properties" },
    { "logger.hadoop.appenderRef.console.ref", "^logger[._-]hadoop[._-]appenderRef[._-]console[._-]ref$", "flink-log4j-cli.properties" },
    { "logger.hive.name", "^logger[._-]hive[._-]name$", "flink-log4j-cli.properties" },
    { "logger.hive.level", "^logger[._-]hive[._-]level$", "flink-log4j-cli.properties" },
    { "logger.hive.additivity", "^logger[._-]hive[._-]additivity$", "flink-log4j-cli.properties" },
    { "logger.hive.appenderRef.file.ref", "^logger[._-]hive[._-]appenderRef[._-]file[._-]ref$", "flink-log4j-cli.properties" },
    { "logger.kubernetes.name", "^logger[._-]kubernetes[._-]name$", "flink-log4j-cli.properties" },
    { "logger.kubernetes.level", "^logger[._-]kubernetes[._-]level$", "flink-log4j-cli.properties" },
    { "logger.kubernetes.appenderRef.console.ref", "^logger[._-]kubernetes[._-]appenderRef[._-]console[._-]ref$", "flink-log4j-cli.properties" },
    { "appender.console.name", "^appender[._-]console[._-]name$", "flink-log4j-cli.properties" },
    { "appender.console.type", "^appender[._-]console[._-]type$", "flink-log4j-cli.properties" },
    { "appender.console.layout.type", "^appender[._-]console[._-]layout[._-]type$", "flink-log4j-cli.properties" },
    { "appender.console.layout.pattern", "^appender[._-]console[._-]layout[._-]pattern$", "flink-log4j-cli.properties" },
    { "logger.hadoopnative.name", "^logger[._-]hadoopnative[._-]name$", "flink-log4j-cli.properties" },
    { "logger.hadoopnative.level", "^logger[._-]hadoopnative[._-]level$", "flink-log4j-cli.properties" },
    { "logger.netty.name", "^logger[._-]netty[._-]name$", "flink-log4j-cli.properties" },
    { "logger.netty.level", "^logger[._-]netty[._-]level$", "flink-log4j-cli.properties" },
...
ConfigStatus update_flink_config(const char *param, const char *value , const char *filename) {
    ...
    if (strcmp(filename, "flink-log4j-cli.properties") == 0 ||
